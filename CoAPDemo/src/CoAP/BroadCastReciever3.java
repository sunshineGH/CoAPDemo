 ...
 */  
public class BroadCastReciever3  
{  
	     int sleepState; //睡眠状态，0表示醒来，1表示睡眠
	     ...
	     public BroadCastReciever3() throws Exception {
	    	 /*unicastSocket = new DatagramSocket();
	    	 ms = new MulticastSocket(5683);*/
	    	 isRecieve = false;
	     }
	     public BroadCastReciever3(InetAddress address,int sleepState,int sleepDuration,int timeSleeping,int nextSleep,boolean isRecieve) throws Exception {
	     ...
	     public BroadCastReciever3(int sleepState,int sleepDuration,int timeSleeping,int nextSleep) throws Exception {
	    	 unicastSocket = new DatagramSocket();
	    	 ms = new MulticastSocket(5683);
	    	 isRecieve = false;
	    	 this.sleepState = sleepState;//val=1,表示sleep;val=0,表示awake
	     ...
	     public void awaking() throws SocketException {
	    	 //if(ms.isClosed()==true) 
	    	try {
	    	 ...
	    	 //if(unicastSocket.isClosed()==true) 
	    		 this.unicastSocket = new DatagramSocket(5683);
	    		/* this.unicastSocket.setReuseAddress(true);*/
	     }
	     public static class Sleep {
	    	 Timer timer;
	    	 public Sleep(BroadCastReciever3 reciever) {
	    		 timer = new Timer();
	     ...
	     public static class Awake {
	    	 Timer timer;
	    	 public Awake(BroadCastReciever3 reciever) {
	    		 timer = new Timer();
	    		 timer.schedule(new TimerTask() {
	    			 public void run() {
	    				// System.out.println("awaking");
	    				 try {
							reciever.awaking();
							System.out.println("======awaking=====");
							reciever.sendAwakePacket();
							//reciever.unicastSocket = new DatagramSocket(5683);
							System.out.println(reciever.unicastSocket.isClosed());							
	     ...
	     public DatagramPacket recieveRequest() throws Exception {
             ...
             System.out.println(this.unicastSocket.isClosed());
             System.out.println(this.unicastSocket.getLocalPort());
      ...
      { 
    	  ...
    	  DatagramSocket uniSocket = new DatagramSocket(2222);
    	  BroadCastReciever3 reciever = new BroadCastReciever3();
    	  DatagramSocket unicastSocket = new DatagramSocket();
    	  MulticastSocket ms = new MulticastSocket(6684);
